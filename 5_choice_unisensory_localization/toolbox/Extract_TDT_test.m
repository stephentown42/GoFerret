function [TDT] = Extract_TDT_test()  %tankDir, blockName)
...
try
    ...
    ferrets = {'F1504_Kiwi', 'F1507_Emu', 'F1510_Beaker', 'F1511_Animal'};
    
    ferret = ferrets{F};
    
    savePath = ['E:\Soraya Data\' ferret '\TDT_sync'];
    if ~exist(savePath, 'dir')
        mkdir(savePath)
    end
    
    
    tankPath = ['F:\UCL_Behaving\' ferret];

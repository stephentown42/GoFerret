function level40_calibrated

% This level was traditionally used for unisensory localization
% The stimulus grid function will not allow co-located trails
% Tracking disabled (in current code - not sure about all history)
...
%__________________________________________________________________________    
    case('PrepareStim')%none to prepare
        ...
        if numel(gf.stim.modalities) == 1
            gf.modality = gf.stim.modalities;
        end

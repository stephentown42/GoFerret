function output_signal = envelopeKW(signal,rampDur,fs)
% This function tries to remove the transients in the signal by enveloping
% the first and last period. Ramp duration is defined by rampDur in **ms**
% envelope(signal,rampDuration,samplerate)

function inSig = tdtSys3playAndRecord(data, stimDevice,recDevice spkrIdx)
%
...
if DA.SetTargetVal( sprintf('%s.length',stimDevice), length(data)) && ...               % Number of stimulus samples
   DA.WriteTargetVEX( sprintf('%s.data',stimDevice), 0, 'F32', data),                   % Stimulus
else

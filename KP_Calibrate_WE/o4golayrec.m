function irf = o4golayrec(golaylen, trim, gap, firFlt, delaySamps, stimDevice, spkrIdx)
...
% Get sample rate
irf.ADrate = DA.GetDeviceSF(stimDevice);
...
% Carve individual segments out of recorded buffer
    ...
    inbuf = tdtSys3play(outbuf*(10/scaleFact), stimDevice, spkrIdx)'; 
    ...
    subplot(2,2,2); 
    [~, irf.fivekp1] = plotSpect(irf.chan1, irf.ADrate);        %fivekp = 5 kHz point

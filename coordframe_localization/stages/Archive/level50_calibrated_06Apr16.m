...
%__________________________________________________________________________    
    case('PrepareStim')%none to prepare
        ...
        %gf.domMod      = gf.stimGrid(2);    % Fixed in parameters
...
%         gf.nStimRepeats = -1;
        ...
        DA.SetTargetVal( sprintf('%s.playDuration', gf.stimDevice), gf.nStimRepeats*(gf.isiSamps+gf.stimSamps));

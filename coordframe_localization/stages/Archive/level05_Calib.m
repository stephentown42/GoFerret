function level05_Calib

% Tracking allows center rewards but not required for trial initiation
...
%__________________________________________________________________________    
    case('PrepareStim')%none to prepare
        ...
        gf.trial_Spkr_stim_V  = getJumboCalib(gf.Spkr_stim_dB, gf.Speaker);
